    ...
    >
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <p className="text-lg sm:text-xl text-warmGray-600 leading-relaxed max-w-2xl mx-auto">
          ...
          bersama. Jadilah yang pertama merasakan pengalaman Livale.
        </p>
        ...
        >
          <div className="flex flex-col sm:flex-row gap-3">
            <Input
              ...
              className="flex-1 px-4 py-3 rounded-lg border-warmGray-300 focus:border-blush-500 focus:ring-blush-500 text-warmGray-800 placeholder:text-warmGray-500" // <-- TAMBAHKAN KELAS INI
              required
            />
            <Button
              type="submit"
